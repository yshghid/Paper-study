...
질병 연관 SNP에 대한 정보는 GWAS 카탈로그 형식으로 다운로드할 수 있다. 카탈로그에는 각 SNP에 대한 염색체 위치, 연관된 유전자, 통계적 유의성 (p-value), accession id 등이 제공된다. 해당 데이터에서 SNP는 1283개이고 유전자는 20개(g1-g20)이다.
